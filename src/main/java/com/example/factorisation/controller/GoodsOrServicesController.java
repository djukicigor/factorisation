...
public class GoodsOrServicesController {
	...
	@RequestMapping(value="getGoodsOrServices", method = RequestMethod.GET)
	...
	public ResponseEntity<GoodsOrServices> add(@RequestBody GoodsOrServices newGoodsOrServices) {
